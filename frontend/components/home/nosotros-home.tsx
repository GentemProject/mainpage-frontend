      ...
      <div className={styles.content}>
        <div className={styles.colm3}>
          <div className={styles.about}>
            ...
            <div className={styles.desc}>
              <p>
                Elige la ubicación y la comunidad que quieres impactar con el
        ...
        <div className={styles.colm3}>
          <div className={styles.about}>
            ...
            <div className={styles.desc}>
              <p>
                De acuerdo al filtro que hayas realizado, selecciona entre el
        ...
        <div className={styles.colm3}>
          <div className={styles.about}>
            ...
            <div className={styles.desc}>
              <p>
                Cuando elijas la fundación que quieres impactar, realiza tu
