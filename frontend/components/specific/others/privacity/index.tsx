      ...
      <div className={style.containerBanner}>
        <div className={style.content}>
          <div className={style.text}>
            <h1 className={style.h1}>POLÍTICA DE PRIVACIDAD</h1>
          </div>
        </div>
      </div>
      <LayoutContainer>
        <div className={style.utilContainer}>
          <h2>Introducción:</h2>
          <p>
            La organización gentem (en adelante &quot;GENTEM&quot;), dando
            cumplimiento a la Ley Estatutaria 1581 de 2012, la Ley de Habeas
            Data 1266 de 2008 y el artículo 15 de la Constitución Política,
            presenta su Política de Tratamiento de Datos Personales.
          </p>
          <h2>Objetivo:</h2>
          <p>
            Establecer los criterios que se deben tener en cuenta al momento de
            la recolección, almacenamiento, uso, circulación y supresión de los
            datos de las personas naturales o jurídicas que serán tratados por
            GENTEM, quien actúa en calidad de Responsable del tratamiento de los
            datos personales. Lo anterior con el fin de proteger el derecho que
            tienen todas las personas a conocer, actualizar y rectificar la
            información que se recolecte sobre ellas.
          </p>
          <h2>Alcance:</h2>
          <p>
            ...
            administrativos, organizacionales y de control que deben ser
            cumplidos por los directivos, colaboradores, contratistas y terceros
            que laboren o tengan alguna relación con GENTEM.
          </p>
          <h2>Marco normativo:</h2>
          <p>
            <ul>
              <li>
                Artículo 15 de la Constitución Política de Colombia Ley
                Estatutaria 1581 de 201, compilada por el Decreto 1074 de 2015,
                conforme la cual se dictan disposiciones generales para la
                protección de datos personales, y demás normas que la
                reglamenten, modifiquen o deroguen.
              </li>
              <li>
                Ley 1266 de 2008, en la que se dictan las disposiciones
                generales de habeas data y se regula el manejo de la información
                contenida en las bases de datos personales, en especial la
                financiera, crediticia, comercial, de servicios y la proveniente
                de terceros países y se dictan otras disposiciones.
              </li>
              <li>
                Instrucciones impartidas por la Superintendencia de Industria y
                Comercio en ejercicio de la función establecida en el artículo
                21 de la Ley 1581 de 2012.
              </li>
              <li>Circular externa 003 del 01 de agosto del 2018</li>
            </ul>
          </p>
          <h2>Responsable:</h2>
          <p>
          ...
          <p>
            ...
            lo tanto GENTEM hará uso de los mismos solamente para las
            finalidades para las que se encuentra debidamente facultada como
            plataforma de creación y firma de documentos legales, en virtud de
            su objeto social, respetando en todo momento la normativa vigente
          ...
          <p>
            <ul>
              <li>
                Incorpora en todas sus actuaciones el respeto por la protección
                de datos personales. En consecuencia, solicitará desde el
                ingreso del dato, autorización para el uso de la información que
                reciba para las finalidades propias de su objeto misional.
              </li>
              <li>
              ...
              <li>
                ...
                efectividad a la Ley estatutaria 1581 de 2012 y demás normativa
                que la complemente, modifique o derogue.
              </li>
              <li>
                Dará a conocer a todos sus titulares los derechos que se derivan
          ...
          <p>
            En cumplimiento de la Ley 518 de 2012 y sus reglamentaciones,
            GENTEM, en calidad de Responsable en el tratamiento de datos
            personales, dará cumplimiento a los siguientes principios:
            <br />
            <ul>
              <li>
                ...
                sujetarse a lo establecido en la ley y en las demás
              ...
              <li>
                ...
                con la Constitución Política y la ley, la cual debe ser
              ...
              <li>
                ...
                podrá hacerse por personas autorizadas por el Titular y/o por
                las personas previstas en la Ley. Los datos personales, salvo la
                ...
                restringido sólo a los Titulares o terceros autorizados conforme
                a la citada ley.
              </li>
              <li>
                <span className={style.bold}>Principio de Seguridad: </span>
                La información sujeta a tratamiento por el Responsable del
                Tratamiento o Encargado del tratamiento a que se refiere la ley
                se deberá manejar con las medidas técnicas, humanas y
                administrativas que sean necesarias para otorgar seguridad a los
                registros, y evitar su adulteración, pérdida, consulta, uso o
              ...
              <li>
                ...
                obligadas a garantizar la reserva de la información, inclusive
                después de finalizada su relación con alguna de las labores que
                comprende el tratamiento, pudiendo sólo realizar suministro o
                comunicación de datos personales cuando ello corresponda al
                desarrollo de las actividades autorizadas en la Ley y en los
          ...
          <p>
            ...
            empresa, quien tomará todas las acciones pertinentes para el
            efectivo cumplimiento de la Política de Protección de Datos
            Personales.
          </p>
          <h2>Privilegios y derechos de los titulares:</h2>
          <p>
            <ol>
              <li>
              ...
              <li>
                Modificar o revocar la autorización y/o solicitar la supresión
                de los datos personales cuando en el tratamiento no se respeten
                los principios, derechos y garantías previstos en la normativa
          ...
          <h2>
            Mecanismos y procedimientos para ejercer los derechos de consulta y
            reclamo:
          </h2>
          <p>
            <ol>
              <li>
                ...
                admin@gentem.org, adjuntando fotocopia del documento de
                identidad del Titular interesado.
              </li>
              <li>
              ...
              <li>
                El Titular o sus causahabientes deberán acreditar su identidad,
                la de su representante, la representación o estipulación a favor
                de otro o para otro. Cuando la solicitud sea formulada por
                persona distinta del Titular y no se acredite que la misma actúa
                en representación de aquél, se tendrá por no presentada.
              </li>
              <li>
                ...
                recibir la respuesta, así como una descripción clara y precisa
                de los datos personales respecto de los cuales el Titular busca
              ...
              <li>
                ...
                ocho (8) días hábiles siguientes a la recepción de la consulta
                y/o petición para que subsane las fallas.
              </li>
              <li>
                Transcurrido un (1) mes desde la fecha del requerimiento, sin
                que el solicitante presente la información requerida, se
                entenderá que ha desistido de su consulta.
              </li>
              <li>
                Las peticiones y/o consultas serán atendidas por GENTEM en un
                término máximo de quince (15) días hábiles contados a partir de
                la fecha de recibo de la misma. Cuando no fuere posible atender
                la petición o consulta dentro de dicho término, este hecho se
              ...
              <li>
                ...
                advertirse el presunto incumplimiento de cualquiera de los
                deberes contenidos en la normativa vigente, podrán presentar una
                solicitud la cual será tramitada bajo las siguientes reglas:
                <ol>
                  <li>
                    Si la solicitud se presenta incompleta, GENTEM deberá
                    requerir al interesado dentro de los ocho (8) días
                    siguientes a su recepción para que subsane las fallas.
                    Transcurrido un (1) mes desde la fecha del requerimiento,
                  ...
                  <li>
                    ...
                    para resolverlo, dará traslado al área de Legal de GENTEM,
                    en un término máximo de dos (2) días hábiles e informará de
                    la situación al interesado.
                  </li>
                  <li>
                    Una vez recibida la solicitud, se incluirá una leyenda que
                    diga &quot;reclamo en trámite&quot; y el motivo del mismo,
                    en un término no mayor a dos (2) días hábiles. Dicha leyenda
                  ...
                  <li>
                    ...
                    de dicho término, se informará al interesado sobre los
